  ...
  structure(
    list(
      ...
      id = c(
        ...
        "patient.current.treatment.protocol",
        ...
        "model.type.of.humanization",
        "model.tumor.preparation",
    ...
    .Names = c("Module", "Field", "Recommendation", "id"),
    row.names = c(NA, -45L),
    class = "data.frame"
  )
}
...
#' @import methods
setMethod(f = "show", signature = "pdxModel", definition = function(object) {
  msg <- sprintf(
    "model.id = %s\ndrug = %s\n",
