...
plotPDX(brca,
  batch = "X-4567.BKM120", vol.normal = TRUE, control.col = "#a6611a",
...
model.type <- SummarizedExperiment::assay(mut)["CDK13", ]
...
waterfall(brca,
  drug = "BYL719", res.measure = "best.average.response",
...
data(brca)
drugSensitivitySig(
  object = brca, drug = "tamoxifen", mDataType = "RNASeq",
