...
Get slope of each model and combine summarize all model slope which belongs to same patient by "mean"
```{r, echo=TRUE}
lpdx_slope <- summarizeResponse(lpdx, response.measure = "slope", 
